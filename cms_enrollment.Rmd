...
The functions and code blocks below create time series datasets for MAP and MA D-SNP plans by Region (NYC, NYC Metro Area, NYS) and adjust the column names:
